...
// Language profile override for fr-FR.

const mwbDatePatternOptions = [
  String.raw`\b(?<day>\d{1,2})(?:er|º)?(?:-|–|—)(?:\d{1,2}) (?<month>${MONTH_NAME})`,
  String.raw`\b(?<day>\d{1,2})(?:er|º)? (?<month>${MONTH_NAME})`,
];

const wDatePatternOptions = [
  String.raw`\b(?<day>\d{1,2})(?:er|º)? (?<month>${MONTH_NAME})(?:-|–|—| – )(?:\d{1,2}) (?:${MONTH_NAME}) (?<year>\d{4})`,
  String.raw`\b(?<day>\d{1,2})(?:er|º)?(?:-|–|—| – )(?:\d{1,2})? (?<month>${MONTH_NAME}) (?<year>\d{4})`,
  String.raw`\b(?<day>\d{1,2})(?:er|º)? (?<month>${MONTH_NAME}) (?<year>\d{4})`,
];
