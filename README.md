...
| mwb_song_conclude        | integer or string | Concluding song. When no digit run is found in the trailing tokens, it will be the default text from the Meeting Workbook.      |
